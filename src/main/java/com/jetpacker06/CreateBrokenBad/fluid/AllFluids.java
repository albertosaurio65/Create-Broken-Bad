...
public class AllFluids {
    ...
    public static final ForgeFlowingFluid.Properties METHYLAMINE_PROPERTIES = new ForgeFlowingFluid.Properties(FluidTypes.METHYLAMINE,  METHYLAMINE, METHYLAMINE_FLOWING).slopeFindDistance(2).levelDecreasePerBlock(2).block(METHYLAMINE_BLOCK).bucket(AllItems.METHYLAMINE_BUCKET);
    ...
    public static final ForgeFlowingFluid.Properties METHANOL_PROPERTIES = new ForgeFlowingFluid.Properties(FluidTypes.METHANOL,  METHANOL, METHANOL_FLOWING).slopeFindDistance(2).levelDecreasePerBlock(2).block(METHANOL_BLOCK).bucket(AllItems.METHANOL_BUCKET);
    ...
    public static final ForgeFlowingFluid.Properties HYDROGEN_PROPERTIES = new ForgeFlowingFluid.Properties(FluidTypes.HYDROGEN,  HYDROGEN, HYDROGEN_FLOWING).slopeFindDistance(2).levelDecreasePerBlock(2).block(HYDROGEN_BLOCK).bucket(AllItems.HYDROGEN_BUCKET);
    ...
    public static final ForgeFlowingFluid.Properties OXYGEN_PROPERTIES = new ForgeFlowingFluid.Properties(FluidTypes.OXYGEN,  OXYGEN, OXYGEN_FLOWING).slopeFindDistance(2).levelDecreasePerBlock(2).block(OXYGEN_BLOCK).bucket(AllItems.OXYGEN_BUCKET);
    ...
    public static final ForgeFlowingFluid.Properties AMMONIA_PROPERTIES = new ForgeFlowingFluid.Properties(FluidTypes.AMMONIA,  AMMONIA, AMMONIA_FLOWING).slopeFindDistance(2).levelDecreasePerBlock(2).block(AMMONIA_BLOCK).bucket(AllItems.AMMONIA_BUCKET);
    ...
    public static final ForgeFlowingFluid.Properties PHENYLACETIC_ACID_PROPERTIES = new ForgeFlowingFluid.Properties(FluidTypes.PHENYLACETIC_ACID,  PHENYLACETIC_ACID, PHENYLACETIC_ACID_FLOWING).slopeFindDistance(2).levelDecreasePerBlock(2).block(PHENYLACETIC_ACID_BLOCK).bucket(AllItems.PHENYLACETIC_ACID_BUCKET);
    ...
    public static final ForgeFlowingFluid.Properties ACETIC_ANHYDRIDE_PROPERTIES = new ForgeFlowingFluid.Properties(FluidTypes.ACETIC_ANHYDRIDE,  ACETIC_ANHYDRIDE, ACETIC_ANHYDRIDE_FLOWING).slopeFindDistance(2).levelDecreasePerBlock(2).block(ACETIC_ANHYDRIDE_BLOCK).bucket(AllItems.ACETIC_ANHYDRIDE_BUCKET);
    ...
    public static final ForgeFlowingFluid.Properties PHENYLACETONE_PROPERTIES = new ForgeFlowingFluid.Properties(FluidTypes.PHENYLACETONE,  PHENYLACETONE, PHENYLACETONE_FLOWING).slopeFindDistance(2).levelDecreasePerBlock(2).block(PHENYLACETONE_BLOCK).bucket(AllItems.PHENYLACETONE_BUCKET);
